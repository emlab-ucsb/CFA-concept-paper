...
country_plot <- country_data_2018 %>%
  ggplot()+
  aes(distance_to_eez_boundary_km, fishing_hours, group = country_name, fill = country_sovereign)+
  stat_summary_bin(fun.y = "sum", geom="bar", bins= 30) +
  facet_wrap(~country_name, ncol = 4, scales = "free_y") +
  theme_bw()+
  labs(x = "Distance to EEZ boundary (km)", y = "Fishing hours")+
  theme(legend.position = "none")

ggsave(paste0(results_dir, "/country_effort_by_distance_bar_plot.png"), dpi = 200, width = 8, height = 9)
```
