############################################################################
#####               het_skagerak_trawling                ####
############################################################################
# 
# This scripts downloads the gridded effort data for Skagerak MPA
# from Google Big Query and then exports it as an rds file.
# 
############################################################################
